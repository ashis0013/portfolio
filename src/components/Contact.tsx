...
export const Contact = () => {
  return (
    <div id='contact' className='max-w-[920px] mt-[-96px] w-full h-screen mx-auto text-left flex flex-col justify-center px-8'>
      <div className='text-2xl sm:text-3xl md:text-5xl text-lprimary dark:text-dprimary mb-8 font-mono'>
        contact
      </div>
      <div className='grid grid-cols-1 md:grid-cols-5'>
        <div className='mr-8 mb-8 md:col-span-3'>
          <p className='text-md md:text-xl text-ltext dark:text-dtext my-8'>
            I am not actively looking for any new roles right now but feel free to reach out to me for any discussions or opportunities. We can also talk about music theory if you want 😃.
          </p>
          <div>
            <Button name='Write Ashis' onClick={() => {
        ...
        <div className='my-8 md:col-span-2'>
          <div className='font-bold text-lsubtext dark:text-dsubtext text-2xl'>Find Ashis elsewhere</div>

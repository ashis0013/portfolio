...
export const Home = () => {
  return (
    <div>
      <div className='max-w-[800px] mt-[-96px] w-full h-screen mx-auto text-left flex flex-col justify-center px-8'>
        <p className='text-lprimary dark:text-dprimary font-mono p-2'>
          Hi, my name is
        </p>
        <h1 className='md:text-7xl sm:text-6xl text-4xl text-ltext dark:text-dtext font-bold md:py-1'>
          Ashis Paul
        </h1>
        <p className='md:text-5xl sm:text-4xl text-xl font-bold py-4 text-lsubtext dark:text-dsubtext'>
